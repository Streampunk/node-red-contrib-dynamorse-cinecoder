...
The software has a dependency on [cinecodernodejs](https://www.npmjs.com/package/cinecodernodejs), please refer to the documentation in this package to understand the relevant license requirements.
